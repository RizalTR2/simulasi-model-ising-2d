...
if __name__ == "__main__":
    grid_size = 20
    temperatures = [1.0, 2.27, 5.0]
    monte_carlo_steps = 200000
    fig, axes = plt.subplots(2, len(temperatures), figsize=(15, 8))
    ...
    for i, T in enumerate(temperatures):
        ...
        ax_grid.set_title(f"Final State at T = {T:.2f}")

        ax_mag = axes[1, i]
        ax_mag.plot(M_history)
        ax_mag.set_title(f"Magnetization at T = {T:.2f}")
